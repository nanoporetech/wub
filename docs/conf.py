...
version = wub.__version__
# The full version, including alpha/beta/rc tags.
release = wub.__version__
...
latex_documents = [
    ('index', MODULE + '.tex',
     TITLE,
     u'ONT Applications Group', 'manual'),
]
...
# Included to display docstrings from class __init__() functions.
